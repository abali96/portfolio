Meteor.startup(function() {
  ...
  Meteor.organizations.linkedin["key"] = 1;
  Meteor.organizations.icspi["key"] = 2;
  Meteor.organizations.voltera["key"] = 3;
  Meteor.organizations.bitmaker["key"] = 4;
  Meteor.organizations.deca["key"] = 5;
  Meteor.organizations.glowstik["key"] = 6;
  Meteor.organizations.top_scholar["key"] = 7;
  // Meteor.organizations.ccs["key"] = 7;
  Meteor.organizations.phasma["key"] = 8;

  Organizations.insert(Meteor.organizations.linkedin);
